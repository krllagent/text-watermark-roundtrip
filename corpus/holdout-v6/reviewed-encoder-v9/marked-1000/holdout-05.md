...
One example made this plain. A fictional member named Ivo selected plot 12 at 07:40. Another member had already received that plot in a paper meeting. The app showed Ivo a green confirmation, so both people arrived on Saturday expecting the same space. The coordinator resolved the conflict in 18 minutes, but the interface had created confidence without agreement.
